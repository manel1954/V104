...
sudo sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version;lxterminal --geometry=72x15 -e sudo sh cerrar_DMRPLUS.sh'" /home/pi/Desktop/Abrir_MMDVMPLUS.desktop
sudo sed -i "5c Icon=/home/pi/$SCRIPTS_version/ICONO_DMRPLUS_ON.png" /home/pi/Desktop/Abrir_MMDVMPLUS.desktop
sudo sed -i "10c Name[es_ES]=Cerrar DMR+" /home/pi/Desktop/Abrir_MMDVMPLUS.desktop
