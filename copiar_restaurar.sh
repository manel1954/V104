...
echo "${CIAN}  1)${BLANCO} Hacer copia de BM, DMR+, LIBRE, RADIO, ESPECIAL, solo DSTAR, solo FUSION,"
echo "     YSF2DMR, DMR2YSF, DMR2NXDN, NXDN, YSF, BlueDV, SVXLINK, Editor GENERAL, "
echo "     ircDDB, DSTAR Repeater y DVSWITCH "
echo ""
echo "${CIAN}  1)${VERDE} Restaurar copia de BM, DMR+, LIBRE, RADIO, solo DSTAR, solo FUSION, "
echo "     YSF2DMR, DMR2YSF, DMR2NXDN, NXDN, YSF, BlueDV, SVXLINK, Editor GENERAL, "
echo "     ircDDB, DSTAR Repeater y DVSWITCH "
echo ""
